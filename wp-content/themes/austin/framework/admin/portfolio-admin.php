...
class MO_Portfolio_Admin {
    ...
    function edit_portfolio_columns($columns) {
        ...
        $new_columns = array(
            ...
            'portfolio_services' => __('Portfolio Services', 'mo_theme')
        );
    ...
    function render_portfolio_metabox($post) {
        ...
        <p>
            <label for="portfolio_services"><?php echo __('Services Offered:', 'mo_theme'); ?></label><br>
            <input id="portfolio_services" name="portfolio_services" type="text"
                   value="<?php echo $portfolio_services; ?>"/>
        </p>
        <p>
    ...
    function save_portfolio($post_id) {
        ...
        if ($post->post_type == 'portfolio') {
            ...
            update_post_meta($post_id, '_portfolio_services_field', esc_attr($_POST['portfolio_services']));
