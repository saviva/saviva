(function() {
	...
	tinymce.PluginManager.requireLangPack('shortcodepanel');

	tinymce.create('tinymce.plugins.shortcodepanel', {
		/**
		...
		init : function(ed, url) {
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('shortcodepanel', n.nodeName == 'IMG');
			});
		},
		...
		getInfo : function() {
			return {
				longname : 'shortcodepanel',
				author : 'LiveMesh - credit - NextGEN gallery plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('shortcodepanel', tinymce.plugins.shortcodepanel);
})();