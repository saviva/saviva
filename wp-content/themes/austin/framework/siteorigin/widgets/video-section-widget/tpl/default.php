...
echo do_shortcode('[video_section id="' . $id . '" class="' . $class . '" video_id="' . $video_id . '" mp4_url="' . $mp4_url . '" ogg_url="' . $ogg_url . '" webm_url="' . $webm_url . '" placeholder_url="' . $placeholder_url . '" subtitle="' . $subtitle . '" text="' . $text . '" button_text="' . $button_text . '" button_url="' . $button_url . '" overlay_pattern="' . $overlay_pattern . '" overlay_color="' . $overlay_color . '" overlay_opacity="' . $overlay_opacity . '" loop="' . ($settings['loop'] ? 'true' : 'false') . '" muted="' . ($settings['muted'] ? 'true' : 'false') . '" preload="' . $settings['preload'] . '" autoplay="' . ($settings['autoplay'] ? 'true' : 'false') . '"]');
