    ...
    function __construct() {
        parent::__construct(
            ...
            array(
                ...
                "class" => array(
                    "type" => "text",
                    "description" => __("The CSS class to be set for the wrapper div for the carousel. Useful if you need to do some custom styling of our own (rounded, hexagon images etc.) for the displayed items. (optional).", "mo_theme"),
