...
class MO_Framework {
    ...
    function add_actions_filters() {
        ...
        /* Register menus. */
        add_action('init', array(&$this, 'mo_register_menus'), 11);

        /* Register thumbnails. */
        add_action('init', array(&$this, 'mo_register_thumbs'), 11);

        /* Register widgets. */
        add_action('widgets_init', array(&$this, 'mo_register_widgets'), 11);
